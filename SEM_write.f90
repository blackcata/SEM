          ...
          SUBROUTINE OUTPUT
            ...
            USE SEM_module,                                                     &
              ONLY : Y, Z, U, V, W, T, RS, THS,                                 &
                     ...
                     U_COMB, V_COMB, W_COMB, T_COMB, U_c, U_pr, rms_pr, e_COMB
            ...
            USE IO_module
              ...
              IMPLICIT NONE
              INTEGER :: it,j,k
              REAL(KIND=8) :: time_sta, time_end, U_mean(4,1:Nz), rms_mean(11,1:Nz)

              U_mean(1:4,1:Nz)   = 0.0
              rms_mean(1:11,1:Nz) = 0.0
...
! !
              ...
              IF ( INT(time/dt) == Nt) THEN
                OPEN(100,FILE=path_name,FORM='FORMATTED',POSITION='APPEND')
                WRITE(100,*)'VARIABLES = Z,uu,uu_exac,vv,vv_exac,ww,ww_exac,tt,tt_exac,uv,uv_exac,uw,uw_exac,vw,vw_exac,upt,upt_exac,vpt,vpt_exac,wpt,wpt_exac,e,e_exac'
